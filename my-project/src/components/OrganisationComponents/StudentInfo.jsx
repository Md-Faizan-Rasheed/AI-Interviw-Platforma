...
//       className="max-w-md mx-auto mt-8 p-6 bg-green-50 rounded-2xl shadow-lg border border-blue-200 hover:shadow-2xl transition-all duration-300"
//     >
//       <motion.h2
//         initial={{ opacity: 0, scale: 0.8 }}
//         animate={{ opacity: 1, scale: 1 }}
//         transition={{ duration: 0.5 }}
//         className="text-3xl font-extrabold mb-6 text-green-700 text-center"
//       >
//         Student Information
//       </motion.h2>
...
//               className="w-full px-3 py-2 border border-green-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-300"
...
//             whileTap={{ scale: 0.9 }}
//             disabled={loading}
//             className="self-end px-4 py-2 bg-green-500 text-white rounded-lg shadow-md hover:bg-green-600 transition-all"
//           >
...
//               value={formData.otp}
//               onChange={handleInputChange}
//               className="w-full px-3 py-2 border border-green-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 transition-all duration-300"
...
//           whileHover={{ scale: 1.1 }}
//           whileTap={{ scale: 0.95 }}
//           className="w-full py-3 px-4 bg-green-500 text-white font-semibold rounded-lg shadow-md hover:bg-green-600 transition-all"
//         >
//           Submit
//         </motion.button>
//       </form>
        ...
        {showOtpInput && (
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              disabled={loading}
              className="mt-2 w-full py-2 bg-green-500 text-white rounded-lg shadow-md hover:bg-green-600 transition-all"
            >
              {loading ? "Verifying..." : "Verify OTP"}
            </motion.button>
          </motion.div>
